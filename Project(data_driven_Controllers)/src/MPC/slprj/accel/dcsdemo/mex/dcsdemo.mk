...
MODEL                = dcsdemo
MODULES              = dcsdemo_acc.c dcsdemo_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/dcsdemo_acc.mexw64
MAKEFILE             = dcsdemo.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2022b
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2022b
START_DIR            = C:/Users/wvx67826/Desktop/PID/PID/mpc/SolveADiscreteSetMPCProblemInSimulinkExample
S_FUNCTIONS_LIB      = 
NUMST                = 5
NCSTATES             = 4
...
MODELLIB                  = dcsdemo_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = dcsdemo_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/dcsdemo \
...
dcsdemo_acc.obj : $(START_DIR)/slprj/accel/dcsdemo/dcsdemo_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/dcsdemo/dcsdemo_acc.c

dcsdemo_acc_data.obj : $(START_DIR)/slprj/accel/dcsdemo/dcsdemo_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/dcsdemo/dcsdemo_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/dcsdemo/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/dcsdemo/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/dcsdemo/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/dcsdemo/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/dcsdemo/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/dcsdemo/rt_nonfinite.c
