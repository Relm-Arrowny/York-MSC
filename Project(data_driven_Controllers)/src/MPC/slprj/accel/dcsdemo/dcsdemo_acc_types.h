#ifndef RTW_HEADER_dcsdemo_acc_types_h_
#define RTW_HEADER_dcsdemo_acc_types_h_
#include "rtwtypes.h"
...
typedef struct { int32_T MaxIterations ; uint8_T sl_padding0 [ 4 ] ; real_T
ConstraintTolerance ; real_T DiscreteConstraintTolerance ; boolean_T
RoundingAtRootNode ; uint8_T sl_padding1 [ 3 ] ; int32_T MaxPendingNodes ; }
struct_lnQ9KXdSZFplhcBp5LBCc ;
#endif
typedef struct P_dcsdemo_T_ P_dcsdemo_T ;
#endif
