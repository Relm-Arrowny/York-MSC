...
MODEL                = basic
MODULES              = basic_acc.c basic_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/basic_acc.mexw64
MAKEFILE             = basic.mk
...
MODELLIB                  = basic_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = basic_ref.rsp
...
basic_acc.obj : $(START_DIR)/slprj/accel/basic/basic_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/basic/basic_acc.c

basic_acc_data.obj : $(START_DIR)/slprj/accel/basic/basic_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/basic/basic_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/basic/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/basic/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/basic/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/basic/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/basic/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/basic/rt_nonfinite.c
